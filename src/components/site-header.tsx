...
import { navItems, siteContent } from "@/server/content/site-content";
    ...
    <header className="mx-auto w-full max-w-7xl px-6 py-6 lg:px-8">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link
            href={siteContent.navigation.actions.login.href}
          ...
          >
            {siteContent.navigation.actions.login.label}
          </Link>
          <Link
            href={siteContent.navigation.actions.cta.href}
            className="rounded-full bg-cyan-400 px-5 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-cyan-300"
          >
            {siteContent.navigation.actions.cta.label}
          </Link>
        </div>
